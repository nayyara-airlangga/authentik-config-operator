...
import (
	...
	"github.com/nayyara-airlangga/authentik-config-operator/internal/controller"
...
func init() {
	...
	utilruntime.Must(akv1alpha1.AddToScheme(scheme))
...
func main() {
	...
	mgr, err := ctrl.NewManager(ctrl.GetConfigOrDie(), ctrl.Options{
		...
		LeaderElectionID:       "9f0b7368.chevonair.com",
